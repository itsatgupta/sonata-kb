...
Jiras (BASE-458911 etc.) instead of the test's hardcoded "SFC-04" — SME confirmed all such citations valid.
**SME GRADE (2026-08-04): 27/27 Correct (100%)** — ≥80% POC-exit target MET on DeepSeek.
